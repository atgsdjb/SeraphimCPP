...
silent only
cd ~/workspace/SeraphimCPP
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +5 seraphim.cxx
badd +5 ~/workspace/SeraphimCPP/base/10/date.cpp
badd +17 ~/workspace/SeraphimCPP/base/10/date.h
badd +1 root.c
args seraphim.cxx
edit \[File\ List]
...
exe 'vert 1resize ' . ((&columns * 25 + 82) / 165)
exe '2resize ' . ((&lines * 23 + 24) / 48)
exe 'vert 2resize ' . ((&columns * 25 + 82) / 165)
exe 'vert 3resize ' . ((&columns * 69 + 82) / 165)
exe 'vert 4resize ' . ((&columns * 69 + 82) / 165)
argglobal
...
wincmd w
argglobal
edit ~/workspace/SeraphimCPP/base/10/date.cpp
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal nobinary
